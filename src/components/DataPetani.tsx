...
export const DataPetani = () => {
  ...
  const formFields: FormField[] = [
    { name: "nama", label: "Nama", type: "text", required: true, placeholder: "Masukkan nama petani" },
    { name: "umur", label: "Umur", type: "number", required: true, placeholder: "Masukkan umur" },
    { name: "alamat", label: "Alamat", type: "text", required: true, placeholder: "Masukkan alamat lengkap" },
    { name: "jumlahSawah", label: "Jumlah Sawah", type: "number", required: true, placeholder: "Jumlah lahan sawah" },
    { name: "totalLuas", label: "Total Luas (Ha)", type: "number", required: true, placeholder: "Total luas dalam hektar" },
    { name: "totalHasil", label: "Total Hasil (Ton)", type: "number", required: true, placeholder: "Total hasil panen" },
    { 
      name: "status", 
      label: "Status", 
      type: "select", 
  ...
  const handleFormSubmit = (data: any) => {
    if (formMode === "create") {
      ...
      const newPetani: Petani = {
        ...
        alamat: data.alamat,
        jumlahSawah: parseInt(data.jumlahSawah),
        totalLuas: parseFloat(data.totalLuas),
        totalHasil: parseFloat(data.totalHasil),
        status: data.status
      }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Kelola data petani dengan fitur CRUD lengkap</p>
      </div>
      ...
      <CrudForm
        ...
        description={formMode === "create" ? "Masukkan data petani baru" : "Perbarui data petani"}
